<?php
	class playerstatisticalinfodatatask extends basicdatatask{
		...
		public function on_data_task(basicmysql $db,basicmodel $model = null,$param,$default) {
            ...
            if ('player_sum' == $this->m_action) {
                return $this->player_sum($db, $model, $param, $default);
            }

			return parent::on_data_task($db,$model,$param,$default);
		}

        protected function player_sum(basicmysql $db,basicmodel $model =null,$param,$default) {
            //		    print_r($default); die;
            if(is_null($db)) {
                return $default;
            }
