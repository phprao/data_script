 ...
 * +----------------------------------------------------------
 */
class agentsstatisticspromotermodel extends basicdatamodel
{
    public function __construct(basicdi $app = null)
    {
        parent::__construct($app);
        $this->data_task = new agentsstatisticspromoterdatatask();
    }
    ...
    public function updateplayerbypromot($data)
    {
